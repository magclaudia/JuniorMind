...
namespace LinqStock
{
    public class StockFacts
    {
        ...
        [Fact]
        public void Check_CheckIfNumberOfProductsIsUnderAlertThresholds_Method_Under_10Products()
        {
            var stock = new Stock();
            string message = "";
            var productType = new List<Product>()
        ...
        [Fact]
        public void Check_CheckIfNumberOfProductsIsUnderAlertThresholds_Method_Under_5Products()
        {
            var stock = new Stock();
            string message = "";
            var productType = new List<Product>()
        ...
        [Fact]
        public void Check_CheckIfNumberOfProductsIsUnderAlertThresholds_Method_Under_2Products()
        {
            var stock = new Stock();
        ...
        [Fact]
        public void Products_Are_Crossing_Twice_Under_One_Threshold_But_Notification_Is_Only_Once_Received()
        {
            var stock = new Stock();
            string message = string.Empty;
            var productType = new List<Product>()
